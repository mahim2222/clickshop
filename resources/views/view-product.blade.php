            ...
            <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
              <div class="product-image">
                    <div class="product_img_box">
                        <img id="product_img" src="{{asset('storage')}}/{{$product->cover_image}}" data-zoom-image="{{asset('storage')}}/{{$product->cover_image}}" alt="{{$product->cover_image}}" />
                    ...
                    <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4" data-slides-to-scroll="1" data-infinite="false">
                        <div class="item">
                            <a href="#" class="product_gallery_item active" data-image="{{asset('storage')}}/{{$product->cover_image}}"
                            data-zoom-image="{{asset('storage')}}/{{$product->cover_image}}"
                            >
                                <img src="{{asset('storage')}}/{{$product->cover_image}}"
                                alt="{{$product->cover_image}}" />
                            </a>
                        </div>
                        @foreach($product->gellaries as $gellary)
                        <div class="item">
                            <a href="#" class="product_gallery_item active" data-image="{{asset('storage')}}/{{$gellary->image}}"
                            data-zoom-image="{{asset('storage')}}/{{$gellary->image}}"
                            >
                                <img src="{{asset('storage')}}/{{$gellary->image}}"
                                alt="{{$gellary->image}}" />
                            </a>
                        </div>
                        @endforeach
